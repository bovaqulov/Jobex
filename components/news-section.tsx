...
import {useNewsData} from '../data/news.ts';
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {newsData.length != 0 ? newsData.map((news, index) => (
                        ...
                        >
                            <div
                                className="backdrop-blur-md bg-white/80 dark:bg-gray-900/80 rounded-2xl overflow-hidden border border-white/20 hover:border-sky-200 dark:hover:border-sky-800 transition-all duration-300 hover:shadow-xl hover:shadow-sky-100 dark:hover:shadow-sky-900/20 hover:-translate-y-1">
