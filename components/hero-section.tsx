...
export const HeroSection: React.FC = () => {
    ...
    return (
        <section className="top-15 relative min-h-screen flex items-center justify-center overflow-hidden">
            <div
                className="absolute inset-0 bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
                <div
                    className="absolute inset-0 opacity-30 bg-gradient-to-r from-sky-400/10 to-blue-600/10 dark:from-sky-600/10 dark:to-blue-800/10"></div>
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid lg:grid-cols-5 gap-12 items-center">
                  ...
                  {t('about.verified')}
                            ...
                            >
                <span
                    className="bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent">
                  {t('hero.title')}
                </span>
                            </motion.h1>
                    ...
                    >
                        <div className="grid gap-6">
                            ...
                            <div className="relative z-10">
                                <div
                                    className="backdrop-blur-md bg-white/10 dark:bg-gray-800/10 rounded-3xl p-6 border border-white/20">
                                    <ImageWithFallback
                                        src={aimage}
