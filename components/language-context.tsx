...
const translations = {
    ...
    en: {
        ...
        // Hero section
        "hero.title": "Employment Abroad",
        "hero.subtitle": "Professional Service and Reliable Partnership",
        "hero.description": "We will help you find official employment abroad. Verified employers and full document processing.",
        "hero.cta": "Free Consultation",
        "hero.phone": "Call",

        // About section
        "about.title": "About Company",
        "about.description": "We are a team of professionals united by one goal: to make employment abroad accessible, transparent, and safe for everyone looking for work overseas. We select vacancies that match each candidate's qualifications, expectations, and career goals.",
        "about.verified": "Verified Employers",
        "about.verified_desc": "We work only with reliable employers — directly, without intermediaries",
        "about.official": "Official Employment",
        "about.official_desc": "Processing of all necessary documents",
        "about.support": "Support",
        "about.support_desc": "From application submission to adaptation in a new place",
        "about.consultation": "Consultations",
        "about.consultation_desc": "Legal, informational, and practical assistance",
        "about.unique_title": "We understand that each candidate is unique",
        "about.unique_1": "We offer vacancies based on experience and skills",
        "about.unique_2": "We advise on all employment matters",
        "about.unique_3": "We prepare for work and provide training if necessary",
        "about.unique_4": "We help with adaptation in a new country and team",

        // Services section
        "services.title": "Our Services",
        "services.subtitle": "A full range of services for our clients",
        "services.training": "Professional Training",
        "services.training.desc": "Retraining courses in modern professions, practical training, and certification programs",
        "services.insurance": "Insurance and Legal Services",
        "services.insurance.desc": "Medical insurance during the adaptation period, legal support in disputed situations, and consultations on labor legislation",
        "services.placement": "Employment",
        "services.placement.desc": "Vacancy offers based on experience and skills, consultations on all employment issues",
        "services.adaptation": "Adaptation Assistance",
        "services.adaptation.desc": "Assistance in adapting to a new country and team, preparation for work, and training if necessary",
        "services.training.feature1": "Retraining courses in modern professions",
        "services.training.feature2": "Practical training",
        "services.training.feature3": "Certification programs",
        "services.insurance.feature1": "Medical insurance during the adaptation period",
        "services.insurance.feature2": "Legal support in disputed situations",
        "services.insurance.feature3": "Consultations on labor legislation issues",
        "services.placement.feature1": "Vacancy offers based on experience and skills",
        "services.placement.feature2": "Consultations on all employment matters",
        "services.placement.feature3": "Document preparation",
        "services.adaptation.feature1": "Assistance in adapting to a new country",
        "services.adaptation.feature2": "Team support",
        "services.adaptation.feature3": "Preparation for work and training if necessary",

        // Directions section
        "directions.title": "Employment Directions",
        "directions.subtitle": "Main directions for which we offer vacancies abroad",
        "directions.construction": "Construction",
        "directions.production": "Production and Warehouses",
        "directions.logistics": "Logistics and Transportation",
        "directions.services": "Service Sector",
        "directions.it": "IT and Technology",
        "directions.agriculture": "Agriculture and Food Industry",
        "directions.more": "Details",
        "directions.construction.desc": "Construction work, finishing, welding",
        "directions.production.desc": "Production lines, quality control, warehouses",
        "directions.logistics.desc": "Drivers, forwarders, dispatchers",
        "directions.services.desc": "Restaurants, hotels, cleaning",
        "directions.it.desc": "Programming, design, testing",
        "directions.agriculture.desc": "Harvesting, packaging, processing",
        "directions.stats.employed": "Employed",
        "directions.stats.countries": "Countries",
        "directions.stats.partners": "Partners",
        "directions.stats.success": "Successful Placements",

        // News section
        "news.title": "Latest News",
        "news.subtitle": "Current news and opportunities in employment",
        ...
        "contact.consultation": "Get a Free Consultation",
        ...
        // Footer
        "footer.description": "Professional assistance in employment abroad and reliable partnership",
        "footer.quickLinks": "Quick Links",
        "footer.workingHours": "Working Hours",
        "footer.workingHours.time": "Monday - Friday: 9:00 AM - 6:00 PM",
        "footer.rights": "© 2025 Jobex.uz. All rights reserved.",

        // Additional
        "advantages.title": "Our Advantages",
        "advantages.insurance": "Insurance through our office",
        "advantages.direct": "Direct interaction with employers",
        "advantages.support24": "24/7 Support",
        "advantages.replacement": "Candidate replacement possibility within 15 days"
    }
